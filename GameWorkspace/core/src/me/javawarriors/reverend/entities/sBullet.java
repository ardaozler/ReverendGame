...
public class sBullet extends Entity {
	...
	public sBullet(float playerX, float playerY, TiledMapTileLayer collisionLayer, float targetX, float targetY,
		...
		Rot = (float) Math.toDegrees(-Math.atan2(xkatsayisi, ykatsayisi));
		...
		//bam.play(0.8f);
		if (texture == null) {
			texture = new Texture("SpiderBullet.png");
	...
	public void render(SpriteBatch batch) {
		batch.draw(textureRegion, x, y, 0f, 0f, 10f, 29f, 2, 2, Rot);
	}
